...
const (
	...
	// shared networking. It is a label whose value identifies the container ID
	// of the parent container so tasks can configure their network mode
	// accordingly.
	dockerNetSpecLabelKey = "docker_sandbox_container_id"

	// dockerNetSpecHostnameKey
